            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group<?php echo e($errors->has('nip') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nip" type="numeric" class="form-control" name="nip" value="<?php echo e(old('nip')); ?>"  >
                        ...
                        <div class="form-group<?php echo e($errors->has('jabatan_id') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="jabatan_id" type="text" class="form-control" name="jabatan_id" value="<?php echo e(old('jabatan_id')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('golongan_id') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="golongan_id" type="text" class="form-control" name="golongan_id" value="<?php echo e(old('golongan_id')); ?>" >
