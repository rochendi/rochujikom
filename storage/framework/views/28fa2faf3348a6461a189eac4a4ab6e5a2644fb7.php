...
<div class="col-md-6 col-md-offset-3">
	<div class="panel panel-default">
		<div class="panel-head">
			...
			<a href="<?php echo e(url('jabatan/create')); ?>" class="btn btn-primary">Tambah bang</a>
				<table class="table">
					<thead>
						<tr class="success">
							<th>Kode jabatan</th>
					...
					<?php $__currentLoopData = $jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
						<tr>
							...
							<td align="right">
                                ...
                                <td >
                                  <a data-toggle="modal" href="#delete<?php echo e($data->id); ?>" class="btn btn-danger" title="Delete" data-toggle="tooltip"><i class="glyphicon glyphicon-trash"></i>Hapus</a>
